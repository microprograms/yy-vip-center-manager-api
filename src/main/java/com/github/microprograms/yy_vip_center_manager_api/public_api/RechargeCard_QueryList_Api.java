...
public class RechargeCard_QueryList_Api {
    ...
    private static void core(Req req, Resp resp) throws Exception {
        ...
        resp.setData(IgniteUtils.queryAllObject(RechargeCard.class, finalCondition, sorts, pager));
        resp.setPager(new PagerResponse(pager, IgniteUtils.queryCount(RechargeCard.class, finalCondition)));
    }
