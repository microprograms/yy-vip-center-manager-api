...
@MicroApi(comment = "商品类别 - 更新商品类别", type = "read", version = "v0.0.6")
public class GoodsCategory_Update_Api {
    ...
    public static class Req extends Request {
        ...
        @Comment(value = "商品类别名称") @Required(value = false) private String name;
        ...
        @Comment(value = "排序") @Required(value = false) private Integer reorder;
